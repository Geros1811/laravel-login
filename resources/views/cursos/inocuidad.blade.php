...
@section('titulo', 'Categoria Inocuidad')
        ...
        <section class="carousel-container">
            <div class="carousel">
                ...
                <div class="cardsCarousel">
                    <a href="#">
                        <img src="src/Cursos/ISO3100.JPG" alt="Curso Imagen">
                    </a>
                ...
                <div class="cardsCarousel">
                    <a href="#">
                        <img src="src/Cursos/HACCP Analisis de peligros.JPG" alt="Curso Imagen">
                    </a>
                    <br>
                    <div class="card-content">
                        <h3 style="text-align: center; color: #275d90 ;">Inocuidad</h3>
                ...
                <div class="cardsCarousel">
                    <a href="#">
                        <img src="src/Cursos/Distintivo H.JPG" alt="Curso Imagen">
                    </a>
                    <br>
                    <div class="card-content">
                        <h3 style="text-align: center; color: #275d90 ;">Inocuidad</h3>
                ...
                <div class="cardsCarousel">
                    <a href="#">
                        <img src="src/Cursos/Aplicacion de buenas practicas.JPG" alt="Curso Imagen">
                    </a>

                    <div class="card-content">
                        <h3 style="text-align: center; color: #275d90 ;">Inocuidad</h3>

                        <h2>Aplicación de Buenas Prácticas de Manufactura en industria de alimentos</h2>
